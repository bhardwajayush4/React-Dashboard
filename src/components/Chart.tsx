...
export const DoughnoutChart = ({ labels, data, backgroundColor, legends = true, cutout, offset }: DoughnoutChartProps) => {
    ...
    const DoughnoutOptions: ChartOptions<"doughnut"> = {
        responsive: true,
        plugins: {
            legend: {
                display: legends,
    ...
    return < Doughnut data={DoughnoutData} options={DoughnoutOptions} />
}
