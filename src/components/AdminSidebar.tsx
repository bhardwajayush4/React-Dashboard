...
const DivOne = ({ location }: { location: Location }) => (
  <div>
    ...
    <ul>
      ...
      <Li url="/admin/transaction" text="Transcation" Icon={AiFillFileText} location={location} />
    </ul>
  </div>
)
...
const Li = ({ url, text, Icon, location }: liprops) => (
  <li
    style={{ backgroundColor: location.pathname.includes(url) ? "rgba(0,115,255,0.1)" : "white" }}>
